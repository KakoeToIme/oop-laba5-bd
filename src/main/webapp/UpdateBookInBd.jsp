...
<div class="container1">
    <h1>Изменение id книги</h1>
    <form id="updateBookIdForm">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const form = document.getElementById('updateBookIdForm');
        ...
        form.addEventListener('submit', function (event) {
            ...
            xhr.open('POST', 'http://localhost:8081/OOP_Website_war_exploded/updatebook', true);
